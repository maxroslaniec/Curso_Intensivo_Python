...
print(f"Ola {convidados[0].title()}, quer jantar comigo essa noite?\n")

# Envia a mensagem para o segundo convidado
print(f"Ola {convidados[1].title()}, quer jantar comigo essa noite?\n")

# Envia a mensagem para o terceiro convidado
print(f"Ola {convidados[2].title()}, quer jantar comigo essa noite?\n")
...
print(f"O convidado: {convidados_ausentes.title()}, nao podera comparecer.\n")

# Informa que os outros convidados confirmaram presença
print(f"Os convidados: {', '.join(convidados)} confirmaram presença.\n")
...
print(f"{', '.join(convidados)}\n")

# Envia a mensagem para todos os convidados
for convidado in convidados:
    print(f"Olá, {convidado}! Gostaria de jantar comigo?\n")
...
for i in range(4):
  ...
  print(f"Ola {convidado}, sinto muito por ter cancelado o convite.\n")

# Envia a mensagem para os convidados restantes
for i in convidados:
    print(f"Ola {i}, sua reserva esta confirmada!\n")
...
print(f"Estou convidando {len(convidados)} pessoas para o jantar.")